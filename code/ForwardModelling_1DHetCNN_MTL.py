...
def main():
    ...
    np.save("features_min.npy", features_min)
    np.save("features_max.npy", features_max)

    np.save("targets_min.npy", targets_min)
    np.save("targets_max.npy", targets_max)

    np.save("targets_focus_min1.npy", targets_focus_min1)
    np.save("targets_focus_max1.npy", targets_focus_max1)

    np.save("targets_focus_min2.npy", targets_focus_min2)
    np.save("targets_focus_max2.npy", targets_focus_max2)
    ...
    # 保存模型
    model_path = f'HetCNN_1D_MLT_{current_time}_duration_{total_time_str}.pth'
